...
@section('page-title')
    <div class="row g-2 align-items-center">
        ...
        <div class="col-auto ms-auto d-print-none">
            <a class="btn btn-primary" href="{{ route('posts.create') }}">{{ __('CREATE') }}</a>
        </div>
    </div>
@endsection
@section('content')
                ...
                <div class="card-body">
                    <div class="page-header d-print-none">
                        <div class="container-xl">
                            <div class="row g-2 align-items-center">
                                <div class="col">
                                    <div id="total-posts" class="text-secondary mt-1">{{ __('LOADING') }}</div>
                                </div>
                                <div class="col-auto ms-auto d-print-none">
                                    <div class="d-flex">
                                        <div class="me-3">
                                                    ...
                                                    <div class="nav-item dropdown">
                                                        <select id="select-filter" class="form-select mb-2">
                                                            <option value="" disabled selected>
                                                                {{ __('SELECT_FILTER') }}</option>
                                                            <option value="recent">{{ __('MOST_RECENT') }}</option>
                                                            <option value="viewd">{{ __('MOST_READ') }}</option>
                                                            <option value="liked">{{ __('MOST_LIKED') }}</option>
                                                            <option value="video_posts">{{ __('VIDEO_POSTS') }}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="me-3">
                                            <div class="input-icon">
                                                <input id="search-input" type="text" class="form-control"
                                                    placeholder="{{ __('SEARCH') }}" onkeyup="fetchPosts()">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ __('POST_DESCRIPTION') }}
                    </h5>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mt-2">
                                ...
                                <div class="d-flex justify-content-between ms-auto gap-1">
                                    {{-- <b id="view-count py-1" class="text-secondary">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div>
                                    <a class="btn btn-primary btn-sm rounded" href="#" id="comments_url"
                                        data-base-url="{{ route('comments.index') }}">View commetns</a>
                                    <a class="btn btn-primary btn-sm rounded" href="#"
                                        id="edit-post-btn">{{ __('EDIT') }}</a>
                                    <a class="btn btn-danger btn-sm delete-form delete-form-reload rounded"
                                        id="post_delete_url" href="">{{ __('DELETE') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
