 ...
 <link rel="preload" href="{{asset('front_end/'.$theme.'/js/libs/swiper-bundle.min.js')}}" as="script">
 ...
 <script src="{{asset('front_end/'.$theme.'/js/app-head-bs.js')}}"></script>
 ...
 <!-- include main style -->
 <link rel="stylesheet" href="{{asset('front_end/'.$theme.'/css/theme/demo-seven.min.css')}}">
...
{{-- Toaster style --}} 
 ...
 <!-- Custom Style -->
 <link rel="stylesheet" href="{{asset('front_end/'.$theme.'/css/custom.css')}}" as="style">
 
 <!-- Bootstrap Icons -->
 <link rel="stylesheet" href="{{asset('front_end/'.$theme.'/css/sweetalert2.min.css')}}" as="style">
