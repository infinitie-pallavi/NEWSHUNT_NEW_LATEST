        ...
        <div class="breadcrumbs panel z-1 py-2 bg-gray-25 dark:bg-gray-100 dark:bg-opacity-5 dark:text-white">
            <div class="container max-w-xl">
                <ul class="breadcrumb nav-x justify-center gap-1 fs-7 sm:fs-6 m-0">
                    ...
                    <li><span class="opacity-50">About us</span></li>
                </ul>
            </div>
        </div>
            ...
            <div class="container max-w-lg">
                <div class="page-wrap panel vstack gap-4 lg:gap-6 xl:gap-8">
                    <header class="page-header panel vstack justify-center gap-2 lg:gap-4 text-center">
                        <div class="panel">
                            <h1 class="h3 lg:h1 m-0">About Us</h1>
                        </div>
                    </header>
                    <div class="page-content panel fs-6 md:fs-5">{!! $about_us->value !!}</div>
                    <div class="page-footer panel">
                        <p class="fs-7 opacity-60 m-0">Last updated: {{ $about_us->updated_at }}</p>
                    </div>
                </div>
            </div>
        </div>
