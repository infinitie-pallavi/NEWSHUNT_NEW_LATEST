                            ...
                            <div class="d-flex align-items-center">
                                <div class="d-flex align-items-center me-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
                                      ...
                                      <div class="h3 ms-2 mb-0">{{ __('USERS') }}</div>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="d-flex align-items-center me-3">
                                    ...
                                    <div class="h3 ms-2 mb-0">{{ __('TOPICS') }}</div>
                                </div>
                                <div class="d-flex flex-column ms-auto text-end">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="d-flex align-items-center me-3">
                                    ...
                                    <div class="h3 ms-2 mb-0">{{ __('CHANNELS') }}</div>
                                </div>
                                <div class="d-flex flex-column ms-auto text-end">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="d-flex align-items-center me-3">
                                    ...
                                    <div class="h3 ms-2 mb-0">&nbsp; {{ __('POSTS') }}</div>
                                </div>
                                <div class="d-flex flex-column ms-auto text-end">
                                    ...
                                    <div class="divide-y">
                                        @foreach ($recentPost as $post)
                                            <div>
                                                <div class="row">
                                                    <div class="col-auto">
                                                        <img src="{{ $post->image }}" alt="Post img" class="avatar">
                                                    </div>
                                                    <div class="col">
                                    ...
                                    <div class="divide-y">
                                        @foreach ($recentUsers as $user)
                                            <div>
                                                <div class="row">
                                                    <div class="col-auto">
                                                        <img src="{{ $user->profile ?? asset('assets/images/faces/2.jpg') }}"
                                                            alt="" class="avatar">
                                                    </div>
                                                    <div class="col">
                                                        <div class="text-truncate">
