                                                        ...
                                                        <div class="col-auto">
                                                            <div class="post-media panel overflow-hidden max-w-64px min-w-64px">
                                                                <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-1x1">
                                                                    <a href="<?php echo e(url('posts/' . $top_post->slug)); ?>" class="position-cover">
                                                                        <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="<?php echo e($top_post->image); ?>" data-src="<?php echo e($top_post->image); ?>" alt="Hidden Gems: Underrated Travel Destinations Around the World" data-uc-img="loading: lazy">
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div>
                                                            <div class="post-header panel vstack gap-1">
                                                                <h3 class="post-title h6 hover:text-primary m-0 text-truncate-2">
                                                                    <a class="text-none duration-150" href="<?php echo e(url('posts/' . $top_post->slug)); ?>" title="<?php echo e($top_post->title ?? ''); ?>"><?php echo e($top_post->title); ?></a>
                                                                </h3>
                                                            </div>
                                                            <?php if($top_post->channel != null): ?>
                                                                <a href="<?php echo e(url('channels/' . $top_post->channel->slug)); ?>" class="post-comments text-none hstack gap-narrow">
                                                                    <img src="<?php echo e(url('storage/images/' . $top_post->channel->logo)); ?>" alt="channel logo" title="<?php echo e($top_post->channel->name ?? ''); ?>" class="rounded-pill h-20px">
                                                                    <span title="<?php echo e($top_post->channel->name ?? ''); ?>"><?php echo e($top_post->channel->name); ?></span>
                                                                </a>
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
                                ...
                                <div class="block-layout slider-layout swiper-parent uc-dark">
                                    <div class="block-content panel uc-visible-toggle">
                                        <div class="swiper" data-uc-swiper="items: 1; active: 1; gap: 4; prev: .nav-prev; next: .nav-next; autoplay: 6000; parallax: true; fade: true; effect: fade; disable-class: d-none;">
                                            <div class="swiper-wrapper">
                                                <?php $__currentLoopData = $postBanners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="swiper-slide">
                                                        <article class="post type-post panel uc-transition-toggle vstack gap-2 lg:gap-3 h-100 overflow-hidden uc-dark">
                                                            <div class="post-media panel overflow-hidden h-100">
                                                                <div class="featured-image bg-gray-25 dark:bg-gray-800 h-100 d-none md:d-block">
                                                                    ...
                                                                    <a href="<?php echo e(url('posts/' . $banner->slug)); ?>" class="position-cover">
                                                                        <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="<?php echo e($banner->image); ?>" data-src="<?php echo e($banner->image); ?>" alt="No img" data-uc-img="loading: lazy">
                                                                    </a>
                                                                </div>
                                                                <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-16x9 d-block md:d-none">
                                                                    <a href="<?php echo e(url('posts/' . $banner->slug)); ?>" class="position-cover">
                                                                        <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="<?php echo e($banner->image); ?>" data-src="<?php echo e($banner->image); ?>" alt="Solo Travel: Some Tips and Destinations for the Adventurous Explorer" data-uc-img="loading: lazy">
                                                                    </a>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <a href="<?php echo e(url('posts/' . $banner->slug)); ?>" class="position-cover">
                                                                <div class="post-header panel vstack justify-end items-start gap-1 p-2 sm:p-4 position-cover text-white" data-swiper-parallax-y="-24">
                                                                    <h3 class="post-title h5 lg:h4 xl:h3 m-0 max-w-600px text-white text-truncate-2">
                                                                        <a class="text-none text-white" href="<?php echo e(url('posts/' . $banner->slug)); ?>"><?php echo e($banner->title ?? ''); ?></a>
                                                                    </h3>
                                                                    <div>
                                                                        <div class="post-meta panel hstack justify-between fs-7 text-white text-opacity-60">
                                                                            <div class="meta">
                                                                                <div class="d-flex gap-2">
                                                                                    <div>
                                                                                        <div class="justify-content-end">
                                                                                            <span><?php echo e($banner->publish_date); ?></span>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="d-flex mt-1 gap-2">
                                                                                    <div>
                                                                                        <div class="gap-1">
                                                                                            <?php if($banner->channel != null): ?>
                                                                                                <a href="<?php echo e(url('channels/' . $banner->channel->slug)); ?>" class="post-comments text-none hstack gap-narrow" title="<?php echo e($banner->channel->name ?? ''); ?>">
                                                                                                    <img src="<?php echo e(url('storage/images/' . $banner->channel->logo ?? '')); ?>" alt="chanel logo" class="rounded h-20px">
                                                                                                    <?php echo e($banner->channel->name ?? ''); ?>
                                                                                    ...
                                                                                    <div>
                                                                                        <a href="#post_comment" class="post-comments text-none hstack gap-narrow">
                                                                                            ...
                                                                                            <span><?php echo e($banner->comment); ?></span>
                                                                                        </a>
                                                                                    </div>
                                                                                    <div class="justify-content-end">
                                                                                        <i class="bi bi-eye fs-5"></i>
                                                                                        <span><?php echo e($banner->view_count); ?></span>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="actions">
            ...
            <div class="container max-w-xl">
                <div class="section-inner">
                    <div class="row child-cols-12 lg:child-cols g-4 lg:g-6 col-match" data-uc-grid>
                        ...
                        <?php $__currentLoopData = $frontTopics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $topic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($index < 0 || $index > 2 || $topic->posts->isEmpty()): ?>
                                <?php continue; ?>
                            <?php endif; ?>
                            <div class="lg:col-4">
                                <div class="block-layout grid-layout vstack gap-2 lg:gap-3 panel overflow-hidden">
                                    <div class="block-header panel pt-1 border-top">
                                        <h2 class="h6 ft-tertiary fw-bold ls-0 text-uppercase m-0 text-black dark:text-white">
                                            <a class="hstack d-inline-flex gap-0 text-none hover:text-primary duration-150" href="<?php echo e(url('topics/' . $topic->slug ?? '')); ?>" title="<?php echo e($topic->name ?? ''); ?>">
                                    ...
                                    <div class="block-content">
                                        <div class="row child-cols-12 g-2 lg:g-4 sep-x" data-uc-grid>
                                            <?php $__currentLoopData = $topic->posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <article class="post type-post panel uc-transition-toggle">
                                                    <div class="row child-cols g-2 lg:g-3" data-uc-grid>
                                                        <div>
                                                            <div class="post-header panel vstack justify-between gap-1">
                                                                <h3 class="post-title h6 m-0 text-truncate-2 hover:text-primary">
                                                                    <a class="text-none duration-150" href="<?php echo e(url('posts/' . $post->slug)); ?>" title="<?php echo e($post->title); ?>"><?php echo e($post->title ?? ''); ?></a>
                                                                </h3>
                                                                <div class="post-date d-flex gap-narrow fs-7 mb-0 text-gray-900 dark:text-white text-opacity-60 justify-between">
                                                                    <span title="<?php echo e($post->publish_date_news); ?>"><?php echo e($post->publish_date); ?></span>
                                                                    <a href="<?php echo e(url('channels/' . $post->channel_slug)); ?>" class="post-comments text-none hstack gap-narrow" title="<?php echo e($post->name); ?>">
                                                                        <span class="ms-auto"><?php echo e($post->name); ?></span>
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-auto">
                                                            <div class="post-media panel overflow-hidden max-w-72px min-w-72px">
                                                                <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-1x1">
                                                                    <a href="<?php echo e(url('posts/' . $post->slug)); ?>" class="position-cover">
                                                                        <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="<?php echo e($post->image); ?>" data-src="<?php echo e($post->image); ?>" alt="<?php echo e($post->title ?? ''); ?>" title="<?php echo e($post->title ?? ''); ?>" data-uc-img="loading: lazy">
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        </div>
                    ...
                    <div class="block-layout carousel-layout vstack gap-2 lg:gap-3 panel">
                        ...
                        <div class="block-content panel">
                            <div class="swiper" data-uc-swiper="items: 2; gap: 16; dots: .dot-nav; next: .nav-next; prev: .nav-prev; disable-class: d-none;" data-uc-swiper-s="items: 3; gap: 24;" data-uc-swiper-l="items: 5; gap: 24;">
                                <div class="swiper-wrapper">
                                    <?php if(!empty($mostReads)): ?>
                                        <?php $__currentLoopData = $mostReads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mostRead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="swiper-slide">
                                                <div>
                                                    <article class="post type-post panel uc-transition-toggle vstack gap-2">
                                                        <div class="post-media panel overflow-hidden">
                                                            <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-3x2">
                                                                <a href="<?php echo e(url('posts/' . $mostRead->slug)); ?>"
                                                                    class="position-cover">
                                                                    <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="<?php echo e($mostRead->image); ?>" data-src="<?php echo e($mostRead->image); ?>" alt="<?php echo e($mostRead->title ?? ''); ?>" title="<?php echo e($mostRead->title ?? ''); ?>" data-uc-img="loading: lazy">
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <div class="post-header panel vstack gap-1">
                                                            <h3 class="post-title h6 m-0 text-truncate-2 hover:text-primary">
                                                                <a class="text-none duration-150" href="<?php echo e(url('posts/' . $mostRead->slug)); ?>" title="<?php echo e($mostRead->title ?? ''); ?>"><?php echo e($mostRead->title ?? ''); ?></a>
                                                            </h3>
                                                            <div class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1 d-none md:d-block">
                                                                <div>
                                                                    <div class="post-date hstack gap-narrow">
                                                                        <a href="<?php echo e(url('channels/' . $mostRead->channel->slug)); ?>" class="post-comments text-none hstack gap-narrow channel-button" title="<?php echo e($mostRead->channel->name ?? ''); ?>">
                                                                            <span><?php echo e($mostRead->channel->name ?? ''); ?></span>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="post-meta panel hstack justify-between gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1 d-none md:d-block">
                                                                <div>
                                                                    <div class="post-date hstack gap-narrow">
                                                                        <span title="<?php echo e($mostRead->publish_date_news); ?>"><?php echo e($mostRead->publish_date); ?></span>
                                                                    </div>
                                                                </div>
                                                                <div>
                                                                    <a href="<?php echo e(url('posts/' . $mostRead->slug)); ?>#comment-form" class="post-comments text-none hstack gap-narrow" title="Comments">
                                                                        <i class="icon-narrow unicon-chat" title="Commetns"></i>
                                                                        <span title="Comments"><?php echo e($mostRead->comment); ?></span>
                                                                    </a>
                                                                </div>
                                                                <div title="Views">
                                                                    <i class="bi bi-eye fs-5"></i>
                                                                    <span><?php echo e($mostRead->view_count); ?></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </article>
                        ...
                        <div class="block-header panel pt-1 border-top">
                            <h2 class="story-title h6 ft-tertiary fw-bold ls-0 text-uppercase m-0 text-black dark:text-white border-none p-0"
                                ...
                                <div class="block-header panel pt-1">
                                    <h2 class="h6 ft-tertiary fw-bold ls-0 text-uppercase m-0 text-black dark:text-white">
                                        <a class="hstack d-inline-flex gap-0 text-none hover:text-primary duration-150" href="<?php echo e(url('webstories')); ?>">
                                            <span>Read All</span>
                                            <i class="icon-1 fw-bold unicon-chevron-right"></i>
                                        </a>
                                    </h2>
                                        ...
                                        <?php $__currentLoopData = $stories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $story): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="swiper-slide px-1">
                                                <div class="card bg-white dark:bg-gray-800 d-flex flex-column" id="card_style">
                                                    <a href="<?php echo e(url('webstories/' . $story->topic->slug . '/' . $story->slug)); ?>"
                                                        target="_blank" class="position-relative d-block">
                                                        <img src="<?php echo e(asset('storage/' . $story->story_slides->first()->image)); ?>"
                                                        target="_blank"  class="card-img-top" alt="<?php echo e($story->title); ?>">
                                                        <div class="story-progress-container position-absolute bottom-0 start-0 w-100 px-1 pb-2">
                                                            <div class="progress-segments d-flex gap-1">
                                                                <?php $__currentLoopData = $story->story_slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <div id="card_title" class="card-footer text-gray-900 dark:text-white d-flex flex-column h-100">
                                                        <h3 class="post-title h6 m-0 text-truncate-2 hover:text-primary">
                                                            <a class="text-none duration-150" target="_blank" href="<?php echo e(url('webstories/' . $story->topic->slug . '/' . $story->slug)); ?>" title="<?php echo e($story->title ?? ''); ?>">
            ...
            <div class="container max-w-xl">
                <div class="section-inner">
                    <div class="row child-cols-12 lg:child-cols g-4 lg:g-4 col-match" data-uc-grid>
                        <?php $__currentLoopData = $frontTopics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $topic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($index < 3 || $index > 5 || $topic->posts->isEmpty()): ?>
                                <?php continue; ?>
                            <?php endif; ?>
                                ...
                                <div class="block-layout grid-layout vstack gap-2 lg:gap-3 panel overflow-hidden">
                                    <div class="block-header panel pt-1 border-top">
                                        <h2 class="h6 ft-tertiary fw-bold ls-0 text-uppercase m-0 text-black dark:text-white hover:text-primary">
                                            <a class="hstack d-inline-flex gap-0 text-none duration-150" href="<?php echo e(url('topics/' . $topic->slug ?? '')); ?>" title="<?php echo e($topic->name ?? ''); ?>">
                                                <span><?php echo e($topic->name ?? ''); ?></span>
                                                <i class="icon-1 fw-bold unicon-chevron-right"></i>
                                            </a>
                                        </h2>
                                                    ...
                                                    <article class="post type-post panel uc-transition-toggle">
                                                        <div class="row child-cols g-2 lg:g-3" data-uc-grid>
                                                            <div>
                                                                <div class="post-header panel vstack justify-between gap-1">
                                                                    <h3 class="post-title h6 m-0 text-truncate-2 hover:text-primary">
                                                                        <a class="text-none duration-150" href="<?php echo e(url('posts/' . $post->slug)); ?>" title="<?php echo e($post->title ?? ''); ?>"> <?php echo e($post->title ?? ''); ?>

                                                                        </a>
                                                                    </h3>
                                                                    <div class="post-date d-flex gap-narrow fs-7 mb-0 text-gray-900 dark:text-white text-opacity-60 justify-between">
                                                                        <span title="<?php echo e($post->publish_date_news); ?>"><?php echo e($post->publish_date); ?></span>
                                                                        <a href="<?php echo e(url('channels/' . $post->channel_slug)); ?>" class="post-comments text-none hstack gap-narrow channel-button" title="<?php echo e($post->name ?? ''); ?>">
                                                                            <span class="ms-auto"><?php echo e($post->name ?? ''); ?></span>
                                                                        </a>
                                                                    </div>
                                                                </div>
    ...
    <div class="section panel overflow-hidden">
        <div class="section-outer panel dark:text-white">
            <div class="container max-w-xl">
                <div class="section-inner">
                    <div class="row child-cols-12 lg:child-cols g-4 lg:g-6 col-match" data-uc-grid>
                        <?php if($frontTopics->isNotEmpty()): ?>
                            <?php $__currentLoopData = $frontTopics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $topic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($index < 6 || $index > 8 || $topic->posts->isEmpty()): ?>
                                    <?php continue; ?>
                                <?php endif; ?>
                                <div class="lg:col-4">
                                    <div class="block-layout list-layout vstack gap-2 lg:gap-3 panel overflow-hidden">
                                        <div class="block-header panel pt-1 border-top">
                                            <h2 class="h6 ft-tertiary fw-bold ls-0 text-uppercase m-0 text-black dark:text-white">
                                                <a class="hstack d-inline-flex gap-0 text-none hover:text-primary duration-150" href="<?php echo e(url('topics/' . $topic->slug ?? '')); ?>">
                                                    <span><?php echo e($topic->name ?? ''); ?></span>
                                                    <i class="icon-1 fw-bold unicon-chevron-right"></i>
                                                </a>
                                            </h2>
                                        ...
                                        <div class="block-content">
                                            <div class="row child-cols-12 g-2 lg:g-4 sep-x" data-uc-grid>
                                                <div>
                                                    <?php $__currentLoopData = $topic->posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($index == 1): ?>
                                                        <?php break; ?>
                                                        <?php endif; ?>
                                                        <article class="post type-post panel uc-transition-toggle vstack gap-2 lg:gap-3 overflow-hidden uc-dark">
                                                            <div class="post-media panel overflow-hidden">
                                                                <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-4x3">
                                                                    <img class="media-cover image uc-transition-scale-up uc-transition-opaque" title="<?php echo e($post->title); ?>" src="<?php echo e($post->image); ?>" data-src="<?php echo e($post->image); ?>" alt="<?php echo e($post->title); ?>">
                                                                </div>
                                                            </div>
                                                            <div class="position-cover bg-gradient-to-t from-black to-transparent opacity-90">
                                                            </div>
                                                                ...
                                                                <div class="post-meta panel hstack justify-between fs-7 text-white text-opacity-60 mt-1">
                                                                    ...
                                                                    <div class="actions">
                                                                        <div class="hstack gap-1">
                                                                            <a href="<?php echo e(url('posts/' . $post->slug)); ?>#post_comment" class="post-comments text-none hstack gap-narrow">
                                                                                <i class="icon-narrow unicon-chat" title="Comments"></i>
                                                                                <span title="Comments"><?php echo e($post->comment); ?></span>
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <h3 class="post-title h6 lg:h5 m-0 m-0 max-w-600px text-white text-truncate-2">
                                                                    <a class="text-none text-white" href="<?php echo e(url('posts/' . $post->slug)); ?>" title="<?php echo e($post->title); ?>"><?php echo e($post->title); ?></a>
                                                                </h3>
                                                            ...
                                                            <div class="row child-cols g-2 lg:g-3" data-uc-grid>
                                                                ...
                                                                <div class="col-auto">
                                                                    <div class="post-media panel overflow-hidden max-w-72px min-w-72px">
                                                                        <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-1x1">
                                                                            <a href="<?php echo e(url('posts/' . $post->slug)); ?>" class="position-cover">
                                                                                <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="<?php echo e($post->image); ?>" data-src="<?php echo e($post->image); ?>" alt="Tech Innovations Reshaping the Retail Landscape: AI Payments" data-uc-img="loading: lazy" title="<?php echo e($post->title); ?>">
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                    ...
                    <div class="section-inner panel vstack gap-2">
                        <div class="block-layout carousel-layout vstack gap-2 lg:gap-3 panel">
                            <div class="d-flex justify-between">
                                ...
                                <div class="block-header panel pt-1">
                                    <h2 class="h6 ft-tertiary fw-bold ls-0 text-uppercase m-0 text-black dark:text-white">
                                        <a class="hstack d-inline-flex gap-0 text-none hover:text-primary duration-150" href="<?php echo e(url('posts')); ?>">
                                            <span>Read All</span>
                                            <i class="icon-1 fw-bold unicon-chevron-right"></i>
                                        </a>
                                    </h2>
                            ...
                            <div class="block-content panel">
                                <div class="swiper" data-uc-swiper="items: 2; gap: 16; dots: .dot-nav; next: .nav-next; prev: .nav-prev; disable-class: d-none;" data-uc-swiper-s="items: 3; gap: 24;" data-uc-swiper-l="items: 5; gap: 24;">
                                    <div class="swiper-wrapper">
                                        <?php if(!empty($channelFollowed)): ?>
                                            <?php $__currentLoopData = $channelFollowed; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mostRead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="swiper-slide">
                                                    <div>
                                                        <article class="post type-post panel uc-transition-toggle vstack gap-2">
                                                            <div class="post-media panel overflow-hidden">
                                                                <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-3x2">
                                                                    <a href="<?php echo e(url('posts/' . $mostRead->slug)); ?>" class="position-cover">
                                                                        <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="<?php echo e($mostRead->image); ?>" data-src="<?php echo e($mostRead->image); ?>" alt="<?php echo e($mostRead->title ?? ''); ?>" title="<?php echo e($mostRead->title ?? ''); ?>" data-uc-img="loading: lazy">
                                                                    </a>
                                                                </div>
                                                            </div>
                                ...
                                <div class="md:col-8 lg:col-9">
                                    <div class="panel overflow-hidden rounded">
                                        <div class="swiper swiper-main" data-uc-swiper="connect: .swiper-thumbs; items: 1; gap: 8; autoplay: 7000; parallax: true; fade: true; effect: fade; dots: .swiper-pagination; disable-class: last-slide;">
                                            <div class="swiper-wrapper">
                                                <?php $__currentLoopData = $videoPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $videoPost): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="swiper-slide">
                                                        <article class="post type-post h-250px md:h-350px lg:h-500px bg-black uc-dark">
                                                            <div class="post-media panel overflow-hidden position-cover">
                                                                <div class="featured-video bg-gray-700 ratio ratio-3x2">
                                                                    <video class="video-cover video-lazyload min-h-100px" preload="none" loop playsinline>
                                                                        <source src="<?php echo e($videoPost->video); ?>" data-src="<?php echo e($videoPost->video ?? ''); ?>" type="video/mp4">
                                                                        <source src="<?php echo e($videoPost->video); ?>" data-src="<?php echo e($videoPost->video ?? ''); ?>" type="video/webm">
                                                            ...
                                                            <div class="post-header panel position-absolute bottom-0 vstack justify-between gap-2 xl:gap-4 max-300px lg:max-w-600px p-2 md:p-4 xl:p-6 z-1">
                                                                <h3 class="post-title h4 lg:h3 xl:h2 m-0 text-truncate-2" data-swiper-parallax-x="-8">
                                                                    <a class="text-none" href="<?php echo e(url('posts/' . $videoPost->slug)); ?>"><?php echo e($videoPost->title); ?></a>
                                                                </h3>
                                                                            ...
                                                                            <div class="hstack gap-2">
                                                                                <div>
                                                                                    <div class="post-author hstack gap-1">
                                                                                        <a href="page-author.html" class="text-black dark:text-white text-none fw-bold"><?php echo e($videoPost->name); ?></a>
                                                                                    </div>
                                                                                </div>
                                                                                <div>
                                                                                    <div class="post-date hstack gap-narrow">
                                                                                        <span><?php echo e($videoPost->publish_date); ?></span>
                                                                                    </div>
                                                                                </div>
                                                                                <div>
                                                                                    <a href="#post_comment" class="post-comments text-none hstack gap-narrow">
                                                                                        <i class="icon-narrow unicon-chat"></i>
                                                                                        <span><?php echo e($videoPost->comment ?? "0"); ?></span>
                                                                                    </a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                    ...
                                                    <div class="swiper-slide overflow-hidden rounded min-h-64px lg:min-h-100px">
                                                        ...
                                                        <article class="post type-post panel uc-transition-toggle p-1 z-1">
                                                            <div class="row gx-1">
                                                                <div class="col-auto post-media-wrap">
                                                                    <div class="post-media panel overflow-hidden w-40px lg:w-64px rounded">
                                                                        <div class="featured-video bg-gray-700 ratio ratio-3x4">
                                                                            <img class="video-cover min-h-100px" src="<?php echo e($videoPost->video_thumb); ?>" data-src="<?php echo e($videoPost->video_thumb ?? ''); ?>" />
                                                                        </div>
                                                                ...
                                                                <div class="col">
                                                                    <p class="fs-6 m-0 text-truncate-2 text-gray-900 dark:text-white"><?php echo e($videoPost->title); ?></p>
                                                                </div>
                                                            </div>
                                                        </article>
                                                    </div>
                                ...
                                <div class="block-layout grid-layout vstack gap-2 panel overflow-hidden">
                                    ...
                                    <div class="block-content">
                                        <div class="row child-cols-12 g-2 lg:g-4 sep-x">
                                            <?php $__currentLoopData = $latesNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $latest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div>
                                                    <article class="post type-post panel uc-transition-toggle">
                                                        <div class="row child-cols g-2 lg:g-3" data-uc-grid>
                                                            <div class="col-auto">
                                                                <div class="post-media panel overflow-hidden max-w-150px min-w-100px lg:min-w-250px">
                                                                    <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-3x2">
                                                                        <a href="<?php echo e(url('posts/' . $latest->slug)); ?>" class="position-cover">
                                                                            <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="<?php echo e(asset('front_end/' . $theme . '/images/common/img-fallback.png')); ?>" data-src="<?php echo e($latest->image); ?>" alt="The Rise of AI-Powered Personal Assistants: How They Manage" data-uc-img="loading: lazy">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div>
                                                                <div class="post-header panel vstack justify-between gap-1">
                                                                    <h3 class="post-title h5 lg:h4 m-0 text-truncate-2 hover:text-primary">
                                                                        <a class="text-none duration-150" href="<?php echo e(url('posts/' . $latest->slug)); ?>" title="<?php echo e($latest->title ?? ''); ?>"><?php echo e($latest->title ?? ''); ?></a>
                                                                    </h3>
                                                                </div>
                                                                <p class="post-excrept ft-tertiary fs-6 text-gray-900 dark:text-white text-opacity-60 text-truncate-2 my-1"><?php echo substr(strip_tags($latest->description), 0, 310).'...'; ?>

                                                                </p>
                                                                <div class="d-flex justify-between">
                                                                    <div class="mt-3">
                                                                        <a href="<?php echo e($latest->channel ? url('channels/' . $latest->channel->slug) : '#'); ?>" class="post-comments text-none hstack gap-narrow" title="<?php echo e($latest->channel->name ?? ''); ?>">
                                                                            <?php if($latest->channel): ?>
                                                                                <img src="<?php echo e(url('storage/images/' . $latest->channel->logo)); ?>" alt="channel logo" class="rounded h-20px">
                                                                            <?php else: ?>
                                                                                <img src="<?php echo e(url('storage/images/default-logo.png')); ?>" alt="default logo" class="rounded h-20px">
                                                                            <?php endif; ?>
                                                                            <?php echo e($latest->channel->name ?? 'Default Channel Name'); ?>

                                                                        </a>
                                                                    </div>
                                                                    <div class="mt-3 d-flex">
                                                                        <a href="<?php echo e(url('posts/' . $latest->slug)); ?>#comment-form" class="post-comments text-none hstack gap-narrow" title="Commetns">
                                                                            <i class="icon-narrow unicon-chat"></i>
                                                                            <span class="comment-right-margin"><?php echo e($latest->comment); ?></span>
                                                                        </a>
                                                                        <i class="bi bi-eye fs-5" title="Views"></i>
                                                                        <span title="Views"><?php echo e($latest->view_count); ?></span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="block-footer cstack lg:mt-2">
                                        <a href="<?php echo e(url('posts')); ?>" class="animate-btn gap-0 btn btn-sm btn-alt-primary bg-transparent text-black dark:text-white border w-100">
                                            <span>Read More <?php echo e($post_label->value ?? ''); ?></span>
                                                        ...
                                                        <div class="row child-cols g-2 lg:g-3" data-uc-grid>
                                                            <div>
                                                                <div class="hstack items-start gap-3">
                                                                    <span class="h3 lg:h2 ft-tertiary fst-italic text-center text-primary m-0 min-w-24px"><?php echo e($counter); ?></span>
                                                                    <div class="post-header panel vstack justify-between gap-1">
                                                                        <h3 class="post-title h6 m-0">
                                                                            <a class="text-none hover:text-primary duration-150"
                                                                                href="<?php echo e(url('posts/' . $popularPost->slug)); ?>">
                                                                            ...
                                                                            <div class="meta">
                                                                                <div class="d-flex justify-between gap-2">
                                                                                    <div class="post-date gap-narrow">
                                                                                        <span title="<?php echo e($popularPost->publish_date_news); ?>"><?php echo e($popularPost->publish_date); ?></span>
                                                                                    </div>
                                                                                    <div>
                                                                                        <i class="bi bi-eye fs-5"></i>
                                                                                        <span><?php echo e($popularPost->view_count); ?></span>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="actions">
                                ...
                                <div class="widget social-widget vstack gap-2 text-center p-2 border">
                                    ...
                                    <div class="widgt-content">
                                        <form class="vstack gap-1" method="post"
                                            action="<?php echo e(route('subscribe.store')); ?>">
                                            <?php echo csrf_field(); ?>
                                        ...
                                        <ul class="nav-x justify-center gap-1 mt-3">
                                            <li>
                                                <a href="<?php echo e($socialMedia[27]['value'] ?? ''); ?>" class="cstack w-32px h-32px border rounded-circle hover:text-black dark:hover:text-white hover:scale-110 transition-all duration-150">
                                                    <i class="icon icon-1 unicon-logo-facebook"></i>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e($socialMedia[26]['value'] ?? ''); ?>" class="cstack w-32px h-32px border rounded-circle hover:text-black dark:hover:text-white hover:scale-110 transition-all duration-150">
                                                    <i class="icon icon-1 unicon-logo-x-filled"></i>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e($socialMedia[25]['value'] ?? ''); ?>" class="cstack w-32px h-32px border rounded-circle hover:text-black dark:hover:text-white hover:scale-110 transition-all duration-150">
                                                    <i class="icon icon-1 unicon-logo-instagram"></i>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e($socialMedia[29]['value'] ?? ''); ?>" class="cstack w-32px h-32px border rounded-circle hover:text-black dark:hover:text-white hover:scale-110 transition-all duration-150">
...
<?php echo $__env->make('front_end.' . $theme . '.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/infinitie-raj/Code v1.2.0/resources/views/front_end/classic/pages/index.blade.php ENDPATH**/ ?>