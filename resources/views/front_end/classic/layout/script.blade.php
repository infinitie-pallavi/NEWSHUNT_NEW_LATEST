<!-- include jquery & bootstrap js -->
  <script defer src="{{asset('front_end/'.$theme.'/js/libs/jquery.min.js')}}"></script>
  <script defer src="{{asset('front_end/'.$theme.'/js/libs/bootstrap.min.js')}}"></script>

  <!-- include scripts -->
  <script defer src="{{asset('front_end/'.$theme.'/js/libs/anime.min.js')}}"></script>
  <script defer src="{{asset('front_end/'.$theme.'/js/libs/swiper-bundle.min.js')}}"></script>
  ...
  <!-- include app script -->
  <script defer src="{{asset('front_end/'.$theme.'/js/app.js')}}"></script>
  <script defer src="{{asset('front_end/'.$theme.'/js/sweetalert2.js')}}"></script>
  <script defer src="{{asset('front_end/'.$theme.'/js/front-custom.js')}}"></script>
  <script defer src="{{asset('front_end/'.$theme.'/js/custom/weather-custom.js')}}"></script>
  <script defer src="{{asset('front_end/'.$theme.'/js/custom/share.js')}}"></script>
  <script defer src="{{asset('front_end/'.$theme.'/js/custom/custom.js')}}"></script>
  <script defer src="{{asset('front_end/'.$theme.'/js/custom/custom-reactions.js')}}"></script>
  
   {{-- custom script --}}
  <script defer src="{{asset('front_end/'.$theme.'/js/custom/custom-jquery.js')}}"></script>
