...
$(document).ready(function () {
    /* Form Validatiom for Privacy policy */
    $('#submit_button').on('click', function (event) {
        var privacy_policy = $('#tinymce_editor').val();
    ...
    /* Form Validaiton for  Terms and conditions*/
    $('#terms_and_conditions_submit').on('click', function (event) {
        var terms_and_conditions = $('#tinymce_editor').val();
        if (terms_and_conditions.trim() === "") {
    ...
    $('#about_us_submit').on('click', function (event) {
        var about_us = $('#tinymce_editor').val();
        if (about_us.trim() === "") {
