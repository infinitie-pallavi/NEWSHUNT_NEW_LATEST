...
<link href="{{ asset('assets/css/tabler-icons/tabler-icons.min.css') }}" rel="stylesheet"/>
{{-- custom css --}}
...
{{-- Bootsrap --}}
<link rel="stylesheet" href="{{asset('assets/bootstrap/dataTables.bootstrap5.min.css')}}"/>
...
<script src="{{ asset('assets/js/logo_error/logo.error.js') }}"></script>

<!-- Cropper.js CSS -->
<link rel="stylesheet" href="{{asset('assets/css/cropper/cropper.min.css')}}" type="text/css"/>
