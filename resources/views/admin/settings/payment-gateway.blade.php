                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <div class="form-group row mt-3">
                                ...
                                <label for="" class="col-sm-12 form-check-label  mt-2" id='lbl_stripe'>{{__("Status")}}</label>
                                <div class="col-sm-2 col-md-12 col-xs-12  mt-2">
                                    <div class="form-check form-switch ">
                                        ...
                                        <input class="form-check-input switch-input status-switch" type="checkbox" role="switch" name='op' {{ isset($paymentGateway["Stripe"]['status']) && $paymentGateway["Stripe"]['status'] == '1' ? 'checked' : '' }} id="switch_stripe_gateway" aria-label="switch_stripe_gateway" aria-checked="{{ isset($paymentGateway["Stripe"]['status']) && $paymentGateway["Stripe"]['status'] == '1' ? 'true' : 'false' }}">
                                    </div>
                                </div>
                            ...
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-sm-2 col-md-12 col-xs-12  mt-2">
                                    <div class="form-check form-switch ">
                                        ...
                                        <input class="form-check-input switch-input status-switch" type="checkbox" role="switch" name='op' {{ isset($paymentGateway["Razorpay"]['status']) && $paymentGateway["Razorpay"]['status'] == '1' ? 'checked' : '' }} id="switch_razorpay_gateway" aria-label="switch_razorpay_gateway" aria-checked="{{ isset($paymentGateway["Razorpay"]['status']) && $paymentGateway["Razorpay"]['status'] == '1' ? 'true' : 'false' }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-sm-2 col-md-12 col-xs-12  mt-2">
                                    <div class="form-check form-switch ">
                                        ...
                                        <input class="form-check-input switch-input status-switch" type="checkbox" role="switch" name='op' {{ isset($paymentGateway["Paystack"]['status']) && $paymentGateway["Paystack"]['status'] == '1' ? 'checked' : '' }} id="switch_paystack_gateway" aria-label="switch_paystack_gateway" aria-checked="{{ isset($paymentGateway["Paystack"]['status']) && $paymentGateway["Paystack"]['status'] == '1' ? 'true' : 'false' }}">
                                    </div>
                                </div>
